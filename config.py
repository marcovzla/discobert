...
EXPERIMENT_ID = 13
EXPERIMENT_DESCRIPTION = f"experiment13-xlnet-two-classifier-only-stack-for-label-classifier-drop-cls-with-att-2020-09-09" # during training: enter a brief description that will make the experiment easy to identify #during testing: this is the name of the parent directory for different random seed models saved from an experiment
