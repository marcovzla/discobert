...
EXPERIMENT_ID = 19  
EXPERIMENT_DESCRIPTION = "openai-gpt1-two-classifier-train-dev-based-on-rs-15-percent-dev-default-settings-and-cls-token" # during training: enter a brief description that will make the experiment easy to identify #during testing: this is the name of the parent directory for different random seed models saved from an experiment
