...
EXPERIMENT_ID = 14
EXPERIMENT_DESCRIPTION = f"no-buffer-in-label-classifier-current-best-model/two-classifiers-default-settings/experiment3-xlnet-two-classifier-only-stack-for-label-classifier-default-settings-2020-08-11" # during training: enter a brief description that will make the experiment easy to identify #during testing: this is the name of the parent directory for different random seed models saved from an experiment
