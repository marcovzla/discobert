...
PRINT_TREES = False
EXPERIMENT_ID = 19
EXPERIMENT_DESCRIPTION = f"experiment19-roberta-two-classifier-only-stack-for-label-classifier-with-attention-rerun-with-new-eval-added-class-weights-2020-09-25" # during training: enter a brief description that will make the experiment easy to identify #during testing: this is the name of the parent directory for different random seed models saved from an experiment
