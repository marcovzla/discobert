...
EXPERIMENT_ID = 1
EXPERIMENT_DESCRIPTION = "experiment2-OriginalRun-15percent-dev-2020-07-03" # during training: enter a brief description that will make the experiment easy to identify #during testing: this is the name of the parent directory for different random seed models saved from an experiment
