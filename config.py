...
PRINT_TREES = False
EXPERIMENT_ID = 28
EXPERIMENT_DESCRIPTION = f"experiment28-xlnet-two-nodes-on-buffer-and-buffer-size-as-feature-2020-10-18" # during training: enter a brief description that will make the experiment easy to identify #during testing: this is the name of the parent directory for different random seed models saved from an experiment
