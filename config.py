...
EXPERIMENT_ID = 8
EXPERIMENT_DESCRIPTION = "albert-two-classifier-train-dev-based-on-rs-15-percent-dev-default-settings" # during training: enter a brief description that will make the experiment easy to identify #during testing: this is the name of the parent directory for different random seed models saved from an experiment
