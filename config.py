...
PRINT_TREES = True
EXPERIMENT_ID = 17
EXPERIMENT_DESCRIPTION = f"experiment15-roberta-two-classifier-only-stack-for-label-classifier-with-attention-rerun-with-new-eval-2020-09-14" # during training: enter a brief description that will make the experiment easy to identify #during testing: this is the name of the parent directory for different random seed models saved from an experiment
