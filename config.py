...
EXPERIMENT_ID = 13
EXPERIMENT_DESCRIPTION = "bert-rerun-after-removing-model-from-config" # enter a brief description that will make the experiment easy to identify, e.g., "Original-run" means with the default settings before any tweaks, e.g., attention or relation embedding, were added 
LATEST_COMMIT = ""
