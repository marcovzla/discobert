...
ENCODING = 'gpt2' #options in this branch (~~'ed ones are not yet ready): ~~"glove"~~, "glove-2-class", ~~'glove-2-class-stack-only'~~, and (some of) the encodings at the end of the file
...
EXPERIMENT_ID = 43
EXPERIMENT_DESCRIPTION = f"{ENCODING}-defaults" # enter a brief description that will make the experiment easy to identify
