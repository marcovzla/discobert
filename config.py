...
PRINT_TREES = False
EXPERIMENT_ID = 31
EXPERIMENT_DESCRIPTION = f"{ENCODING}-three-nodes-on-buffer-and-three-on-stack-first-four-tokens-of-edu-concat" # during training: enter a brief description that will make the experiment easy to identify #during testing: this is the name of the parent directory for different random seed models saved from an experiment
