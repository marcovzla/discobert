...
EXPERIMENT_ID = 7
EXPERIMENT_DESCRIPTION = "experiment7-distilbert-two-classifier-train-dev-based-on-rs-15-percent-dev-default-settings-2020-07-30" # during training: enter a brief description that will make the experiment easy to identify #during testing: this is the name of the parent directory for different random seed models saved from an experiment
