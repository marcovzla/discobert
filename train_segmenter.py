...
if __name__ == '__main__':
    ...
    if config.DEBUG == True:
        ...
        experiment_dir_path = os.path.join(config.SEGMENTER_OUTPUT_DIR, "experiment" + str(config.EXPERIMENT_ID) + "-" + config.SEGMENTER_EXPERIMENT_DESCRIPTION + "-" + str(date.today()))
