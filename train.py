...
def main(experiment_dir_path):
    ...
    for epoch in range(config.EPOCHS):
        ...
        print("START DEV")
        pred_trees, gold_trees = engine.eval_fn(valid_ds[:10], model, device) #ATTN: only doing three shortest docs for now #todo:make sure to undo the partitioning here
